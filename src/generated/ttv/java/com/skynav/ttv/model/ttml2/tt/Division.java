 ...
 *         &lt;group ref="{http://www.w3.org/ns/ttml}BlockOrEmbedded.class" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Division {
    ...
    @XmlElements({
        @XmlElement(name = "animate", type = AnimateEltype.class),
        @XmlElement(name = "set", type = Set.class)
    })
    protected List<Object> animationClass;
    @XmlElement(name = "region")
    protected Region layoutClass;
    @XmlElements({
    ...
    protected List<Object> blockOrEmbeddedClass;
     ...
     * 
     */
    public List<Object> getAnimationClass() {
        if (animationClass == null) {
            animationClass = new ArrayList<Object>();
        }
     ...
     *     
     */
    public void setLayoutClass(Region value) {
        this.layoutClass = value;
    }

    /**
     * Gets the value of the blockOrEmbeddedClass property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the blockOrEmbeddedClass property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBlockOrEmbeddedClass().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getBlockOrEmbeddedClass() {
        if (blockOrEmbeddedClass == null) {
            blockOrEmbeddedClass = new ArrayList<Object>();
        }
        return this.blockOrEmbeddedClass;
    }
